...
\begin{frame}{Proof Outline for the \connectivity problem: Main Claims (cont.)}
...
\begin{frame}{Backup: Candidate Theorem Slide}
  ...
  \vspace{0.5em}
  For every instance of the \coverage problem, the algorithm returns a feasible solution of value at most
  \[
    O(\log m)\cdot \OPT.
  \]
