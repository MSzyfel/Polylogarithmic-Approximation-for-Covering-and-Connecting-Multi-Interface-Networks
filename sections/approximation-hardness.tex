...
\begin{proof}
    ...
    \begin{proof}
        ...
        \]
        Since the depth of the DAG is at most the depth of the tree (plus $1$), we know that there exists an apropriate constant $c'$ such that the number of vertices in $D_B$ is at most \[
