...
% Terminal group 1: {v1, v5, v8} drawn with double circle.
% Terminal group 2: {v3, v7} drawn with triple circle.
% Steiner vertices used in solution (v4, v10) drawn with dashed border.
% Steiner tree: v1 -[blue]- v10 -[blue]- v4 -[orange]- v5
%                                v10 -[green]- v8
%              v3 -[orange]- v7  (group 2 connection)
...
\begin{tikzpicture}[scale=0.80]
    ...
    % terminal group 2 vertices (triple circle – all 3 drawn manually for equal spacing)
    \node[circle, draw=none, minimum size=8mm, inner sep=0pt] (v3) at (4.2, 2.9) {};
    \node[circle, draw=none, minimum size=8mm, inner sep=0pt] (v7) at (3.9,-2.6) {};
    % terminal group 1 vertices (double circle)
    ...
    \begin{scope}[shift={(v7.center)}]
        \fill[iface3] (-0.26,-0.12) rectangle (-0.02,0.12);
        \fill[iface4] (0.02,-0.12) rectangle (0.26,0.12);
    \end{scope}
    ...
    \begin{scope}[shift={(v10.center)}]
        ...
        \fill[iface3] (0.02,-0.12) rectangle (0.26,0.12);
    \end{scope}
    % triple border for v3 and v7 (all 3 circles manual, equal 0.6mm spacing)
    \draw[line width=0.4pt] (v3.center) circle (4.00mm);
    \draw[line width=0.4pt] (v3.center) circle (4.60mm);
    \draw[line width=0.4pt] (v3.center) circle (5.20mm);
    \draw[line width=0.4pt] (v7.center) circle (4.00mm);
    \draw[line width=0.4pt] (v7.center) circle (4.60mm);
    \draw[line width=0.4pt] (v7.center) circle (5.20mm);
\end{tikzpicture}

\vspace{1mm}
{\scriptsize Contours represents terminal groups (double for groupe 1 and triple for group 2)}
\end{minipage}
\hfill
\begin{minipage}[t]{0.49\linewidth}
\centering
\begin{tikzpicture}[scale=0.80]
    ...
    \draw[iface4, line width=2.0pt] (v3)  -- (v7);  % iface4 (orange) – group 2
...
\vspace{1mm}
{\scriptsize Colors represent active interfaces: only bold edges are covered}
\end{minipage}
