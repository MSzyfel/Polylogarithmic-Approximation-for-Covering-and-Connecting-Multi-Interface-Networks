...
In \Cref{sec:preliminaries}, we give notations, define the problems formally, and recall the elements of probability theory useful for the analysis of our algorithms. We also describe the preprocessing used on instances of the \coverage and \connectivity problems.
