...
\end{proof}
\subsection{$1.39\Delta$-approximation for the min-sum connection problem}
\begin{algorithm}[H]
\caption{A $1.39\Delta$-approximation algorithm for the min-sum connection problem.}
Initialize $\lambda_A(v) = \emptyset$ for every $v \in V$.
...
\end{algorithm}
\begin{theorem}
    The above algorithm is a $1.39\Delta$-approximation algorithm for the min-sum connection assignment problem.
\end{theorem}
\begin{proof}
